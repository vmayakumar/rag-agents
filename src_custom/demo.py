"""
Consolidated Demo for RAG Agent Components
...
from src_custom.document_processor import DocumentProcessor


def demo_rag_agent():
    """Demonstrate RAG Agent with Memory functionality."""
    print("🧠 RAG Agent with Memory Demonstration")
    print("=" * 50)
...
def demo_embedding_manager():
    ...
    print("🔍 Embedding Manager Demonstration")
    print("=" * 50)
    ...
    print("\n" + "=" * 50)
    print("🧪 Testing Embedding Manager Functions:")
    print("-" * 40)
...
def demo_document_processor():
    """Demonstrate Document Processor functionality."""
    print("📄 Document Processor Demonstration")
    print("=" * 50)
...
def demo_delete_pinecone_records():
    ...
    try:
        ...
        print(f"Total vectors: {new_stats.get('total_vector_count', 'Unknown')}")
...
def main():
    ...
    print("🚀 RAG Agent Components Demo")
    print("=" * 50)
    print("Choose a demonstration:")
    print("1. RAG Agent with Memory")
    print("2. Embedding Manager")
    print("3. Memory Manager")
    print("4. Document Processor")
